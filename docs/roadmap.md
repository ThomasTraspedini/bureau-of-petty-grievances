...
| C10 | Evaluation access and cost control | Evaluators enter without visible friction while credits, idempotency, rate limits, global budget, refund, alerts, and kill switches protect paid actions. | C07 | ready |
