...
| C04 | Deterministic determination | Validated structured facts produce an inspectable assessment, accepted factors, remedy constraints, and stable presentation parameters. | C03 | ready |
