...
| C07 | Persistent public record | Determinations persist behind unguessable public identifiers with explicit lifecycle, unlisted rendering, reporting, unpublishing, and deletion behavior. | C06 | ready |
