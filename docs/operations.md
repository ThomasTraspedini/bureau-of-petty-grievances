...
Authenticated account creation, repository authorization, and secret entry happen in the provider dashboards. Operators do not paste credentials into chat. The production deployment and C15 verification are complete. The steps above remain the reproducible runbook for subsequent deployments.
